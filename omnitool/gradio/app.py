...
with gr.Blocks(theme=gr.themes.Default()) as demo:
    ...
    def update_model(model_selection, state):
        ...
        elif model_selection == "omniparser + gemini-2.5-pro-exp-03-25" or model_selection == "omniparser + gemini-2.0-flash" or model_selection == "omniparser + gemini-2.0-flash-lite" or model_selection == "omniparser + gemini-1.5-pro" or model_selection == "omniparser + gemini-2.5-flash-preview-04-17":
